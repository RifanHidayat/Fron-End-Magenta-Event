...
const Table = (props) => {
          ...
          >
            <CDropdown color="secondary">
              ...
              <CDropdownMenu className="pt-0" placement="left-end">
                <CDropdownItem to={`/pictb/in-transaction/${row.id}`}>
                  IN OUT Transaksi
                </CDropdownItem>
                <CDropdownItem to={`/pictb/quotation-po/${row.id}`}>
                  Quotation PO Transaksi
                </CDropdownItem>
                <CDropdownItem to={`/pictb/transaction-pictb/${row.id}`}>
                  Rekap Transaksi TB{" "}
                </CDropdownItem>
              </CDropdownMenu>
            </CDropdown>
  ...
  const deletePIC = (id) => {
    Swal.fire({
      ...
      preConfirm: () => {
        return axios
          .delete(`${API_URL}/api/pic/delete-pictb/` + id)
