      ...
      <CContainer>
        <CFormGroup row>
          <CCol xl="3">
            <Card
              color="red"
              style={{ backgroundColor: hoverCardFinish, height: "150px" }}
            >
              <CCardBody style={{ backgroundColor: hoverCardFinish }}>
                <img
                  ...
                  style={{
                    width: "30px",
                    height: "30px",
                    backgroundColor: hoverCardFinish,
                  }}
                ></img>
                <span
                  style={{
          ...
          <CCol xl="3">
            <Card
              color="red"
              style={{ backgroundColor: hoverCardInProgress, height: "150px" }}
            >
              <CCardBody>
                <img src={icon} style={{ width: "30px", height: "30px" }}></img>
                <span style={{ color: "white", fontFamily: "Time New Roman" }}>
                  {" "}
                ...
                >
                  <b>
                    {" "}
                    <span
                      style={{ color: "white", fontFamily: "Time New Roman" }}
                    >
                      {totalApproved}
                    </span>
                  </b>
              ...
              <CCardFooter
                style={{
                  height: "10px",
                  marginTop: "40px",
                  backgroundColor: hoverCardInProgress,
                }}
              >
          ...
          <CCol xl="3">
            <Card
              color="red"
              style={{ backgroundColor: hoverCardPending, height: "150px" }}
            >
              <CCardBody>
                <img src={icon} style={{ width: "30px", height: "30px" }}></img>
                <span style={{ color: "white", fontFamily: "Time New Roman" }}>
              ...
              <CCardFooter
                style={{
                  height: "10px",
                  marginTop: "40px",
                  backgroundColor: hoverCardPending,
                }}
              >
                <div style={{ textAlign: "center" }}>
                  <span
          ...
          <CCol xl="3">
            <Card
              color="red"
              style={{ backgroundColor: hoverCardRejected, height: "150px" }}
            >
              <CCardBody>
                <img src={icon} style={{ width: "30px", height: "30px" }}></img>
                <span style={{ color: "white", fontFamily: "Time New Roman" }}>
              ...
              <CCardFooter
                style={{
                  height: "10px",
                  marginTop: "40px",
                  backgroundColor: hoverCardRejected,
                }}
              >
                <div style={{ textAlign: "center" }}>
                  <span
